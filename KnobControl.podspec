...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ngominhtrint"
  ...
  s.author             = { "tri.ngo" => "ngominhtrint@gmail.com" }
  # Or just: s.author    = "tri.ngo"
  # s.authors            = { "tri.ngo" => "ngominhtrint@gmail.com" }
  # s.social_media_url   = "http://twitter.com/tri.ngo"
  ...
  s.source       = { :git => "https://github.com/ngominhtrint/KnobCon.git", :tag => "1.0.0" }
